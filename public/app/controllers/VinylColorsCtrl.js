...
// generates URL for page
	$scope.addToURL = function () {
  	$scope.sampleURL = "https://vinylcolors.firebaseapp.com/#/main/" + $scope.BaseColor.$id + "/" + $scope.SecondaryColor.$id + "/" + $scope.TertiaryColor.$id + "/" + $scope.Configuration.$id + "/" + $scope.SpecialConfiguration.$id + "/" + $scope.LabelColor.substr(1) + "/" + $scope.TextColor.substr(1);
